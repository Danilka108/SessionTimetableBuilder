...
public partial class DisciplineCardView : ReactiveUserControl<DisciplineCardViewModel>
{
    public DisciplineCardView()
    {
        InitializeComponent();
    ...
    private async Task DoOpenEditor(
        InteractionContext<DisciplineEditorViewModel, Unit> context)
    {
        var editor = new DisciplineEditorWindow
        {
