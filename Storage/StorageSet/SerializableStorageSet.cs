...
internal class SerializableStorageSet
{
    ...
    internal StorageSet<TEntity> ToTypedStorageSet<TEntity>(StorageTransaction? transaction = null)
    {
        var typedEntities = _entities
            .Select
            (
                entity => new IdentifiedEntity<TEntity>
                (
                    entity.Id,
        ...
        (StorageSet<TEntity> storageSet)
    {
        var serializableEntities = storageSet
            ...
            (
                entity =>
                    new IdentifiedEntity<SerializableEntity>
                    (
                        entity.Id,
    ...
    {
        return new SerializableStorageSet(0, new List<IdentifiedEntity<SerializableEntity>>());
    }
    ...
    {
        private readonly JsonConverter<IEnumerable<IdentifiedEntity<SerializableEntity>>>
            _entitiesConverter;
        ...
        private IEnumerable<IdentifiedEntity<SerializableEntity>> ReadEntities
        (
            ref Utf8JsonReader reader,
            JsonSerializerOptions options
        )
