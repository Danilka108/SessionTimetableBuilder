...
public class DeleteClassroomFeatureUseCase
{
        ...
        Domain.Project.ClassroomFeature featureToDelete, CancellationToken token)
    {
        ...
        foreach (var classroom in classrooms)
        {
            ...
            if (contains) throw new ClassroomFeatureReferencedByClassroomException(classroom);
        }
        ...
        foreach (var discipline in disciplines)
        {
            ...
            if (contains) throw new ClassroomFeatureReferencedByDisciplineException(discipline);
        }
    }
}
