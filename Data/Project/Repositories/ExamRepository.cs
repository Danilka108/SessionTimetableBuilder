...
using Domain;
using Audience = Domain.Models.Audience;
using BellTime = Domain.Models.BellTime;
using Discipline = Domain.Models.Discipline;
using Group = Domain.Models.Group;
using Teacher = Domain.Models.Teacher;

namespace Data.Project.Repositories;

internal class ExamRepository : BaseRepository<Exam, Domain.Models.Exam>
{
    ...
    ) : base(projectStorageProvider.ProvideStorage(), new Exam.Helper())
    {
